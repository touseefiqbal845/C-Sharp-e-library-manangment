<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" Codefile="user profile.aspx.cs" Inherits="WebApplication1.user_profile" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        ...
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound" AutoGenerateColumns="False" Width="749px">
                            <Columns>
