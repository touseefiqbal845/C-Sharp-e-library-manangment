<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site1.Master" Codefile="Get Your PDF Book.aspx.cs" Inherits="WebApplication1.Get_Your_PDF_Book" %>
    ...
    <body>
        <div>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                ForeColor="#333333" GridLines="None" OnRowCommand="GridView1_RowCommand" OnRowDeleting="GridView1_RowDeleting"
                Width="513px">
